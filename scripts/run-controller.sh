...
# Force a non-existent opencode binary path so the adapter falls back to stubs
# when the user runs without an active OpenCode login.
export RELIABILITY_OPENCODE_BIN="${RELIABILITY_OPENCODE_BIN:-/nonexistent/opencode-binary-by-script}"
