# fable-mythos-controller-opencode

**Walking Skeleton** — concept validation for a deterministic Python asyncio controller that drives the Reliability Harness v2 inside [OpenCode CLI](https://opencode.ai).

> ⚠️ **NOT production-ready.** This is a concept-validation scaffold to test whether a code-based controller is preferable to the prompt-only harness in [`emco1234/fable-mythos-opencode`](https://github.com/emco1234/fable-mythos-opencode). The existing `fable-mythos-opencode` repo is unchanged on `main` and continues to work via pure prompting.
...
| OpenCode CLI adapter (stub) | ✅ Implemented |
...
2. Port to `fable-mythos-opencode` as a new major version
...
├── adapters/
│   └── opencode_adapter.py             # OpenCode CLI spawn adapter (stub)
├── examples/
...
- Spawn real OpenCode subagents (the adapter is a stub)
...
- [`emco1234/fable-mythos-opencode`](https://github.com/emco1234/fable-mythos-opencode) — Prompt-based harness (production-ready, unchanged)
...
- [`emco1234/fable-mythos-controller-zcode`](https://github.com/emco1234/fable-mythos-controller-zcode) — Same skeleton for ZCode
